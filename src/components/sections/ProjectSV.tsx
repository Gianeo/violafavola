      ...
      <Container className="space-y-8 md:space-y-0">
        <div className="grid grid-cols-4 gap-y-6 md:grid-cols-12 md:mb-24">
          <div className="col-span-4 flex items-center md:row-start-1 md:col-start-2 md:col-span-9">
            <div className="copy-primary">2/3 Previous Project</div>
          </div>
        ...
        <div className="grid grid-cols-4 gap-6 md:grid-cols-12 md:gap-8 md:min-h-145">
          <div className="col-span-4 rounded-md relative overflow-hidden aspect-auto md:col-start-2 md:col-span-5 md:aspect-auto h-104 md:h-auto md:max-h-218.5 shadow-2xl shadow-neutral-200">
            <Image
          ...
          <div className="col-span-4 space-y-6 md:col-span-5 md:space-y-8">
            ...
            <div className="hidden md:block space-y-2 px-6 py-6 md:max-w-sm md:px-12 md:py-8">
              <h4 className="title-sm">Mobile App Design</h4>
              <p className="copy-sm">To bridge physical and digital experiences, I applied the app’s colour system to the office space, reinforcing visual cues that help users navigate the product more intuitively.</p>
            </div>
          </div>
        </div>
      </Container>
